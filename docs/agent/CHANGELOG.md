...
## 2026-06-27 Plan Builder: setup-to-review bridge

- Added `/plan` as a consolidated browser view connecting local evidence, course goal, accepted questions, and review cards.
- Added a Plan Builder link to the Start Here panel and main nav.
- Documented that the plan view is local-only and does not enable remote LLM calls, publish data, or run target repo code.
- Captured screenshot evidence for the new page.
